...
### 1) Compare "Potential for forest regeneration in tropical regions" vs  Global tree cover (existing and potential)
...
### 2) Compare "Potential for forest regeneration in tropical regions" vs  Total carbon sequestration potential from reforestation
...
### 3) Compare "Indian restoration areas" and "Potential for forest regeneration in tropical regions"
